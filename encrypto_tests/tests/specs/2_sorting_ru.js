...
describe('sorting 2 ru; Test the "Капитализация" sorting', function(){
    ...
    it('Select "Капитализация" from the drop-down menu', function(){  
        ...
        const market_cap = "Капитализация"
        const attr_market_cap = Myportfolio.market_cap_ru.getAttribute('content-desc')
        expect(market_cap).toBe(attr_market_cap)

        Myportfolio.market_cap_ru.click()
