...
describe('sorting 3 ru; Test the "Рост" sorting', function(){
    ...
    it('Select "Рост" from the drop-down menu', function(){  
        ...
        const trend_up = "Рост"
        const attr_trend_up = Myportfolio.trend_up_ru.getAttribute('content-desc')
        expect(trend_up).toBe(attr_trend_up)

        Myportfolio.trend_up_ru.click()
