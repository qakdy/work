...
describe('add coin test 4 ru; Check adding a coin to "Profile", when scrolling and pressing the [Отмена] button in the "Детали" window', function(){
    ...
    it('STEP 4. In the "Детали" window, click the [Отмена] button' , function(){
        ...
        const cancel = 'Отмена'
        const attr_cancel = Details.cancel_ru.getAttribute('content-desc')
        expect(cancel).toBe(attr_cancel)

        Details.cancel_ru.click()
