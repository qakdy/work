...
describe('coin transaction in 3 en; Check the creation of an In-Exchange transaction with an empty field coin value', function(){
    ...
    it('EXPECTED RESULT. Below the "USD Token" input window, a message is displayed with the red text "Please enter the quantity"', function(){ 
