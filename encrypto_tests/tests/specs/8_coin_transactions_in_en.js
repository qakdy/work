...
describe('coin transaction in 8 en; Check the creation of an In-Exchange transaction with the current value of the coin and the choice of wallet from the drop-down menu when canceling the transaction', function(){
