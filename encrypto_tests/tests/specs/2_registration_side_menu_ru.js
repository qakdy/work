...
describe('registration side menu 2 ru; Check registration in the application with an empty field "My portfolio" and validly filled fields "Master password", "Confirm password"', function(){
    ...
    it('EXPECTED RESULT.Under the "Мое портфолио" field, an informational message is displayed in red "Пожалуйста, введите имя".', function(){ 
