...
describe('coin transaction out 2 en; Check the creation of an out-transfer transaction with a changed coin value and a wallet selection from the drop-down list', function(){
    ...
    it('STEP 3. Select "Transfer" from the second drop-down list', function(){ 
       ...
       const text_transfer = 'Transfer'
       const attr_text_transfer = AddTransaction.transfer.getAttribute('content-desc')
       expect(text_transfer).toBe(attr_text_transfer)

       AddTransaction.transfer.click()
    })
    ...
    it('STEP 5. Enter the value of the coin in the "USD" field manually', function(){ 
        ...
        const text_usd_from_btc = '20000, Price'
    ...
    it('STEP 9. Press the [Save] button', function(){ 
