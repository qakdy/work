...
describe('coin transaction in 9 ru; Check the creation of an In-Mining transaction with the value of the coin removed and the choice of wallet from the drop-down menu when canceling the transaction', function(){
