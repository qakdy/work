...
describe('coin transaction in 10 en; Checking the formation of growth In-Staking with the rate of coins entered manually and choosing a wallet from the drop-down menu when canceling the growth', function(){
