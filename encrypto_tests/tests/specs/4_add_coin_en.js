...
describe('add coin test 4 en; Check adding a coin to "Profile", when scrolling and pressing the [Canсel] button in the "Details" window', function(){
    ...
    it('STEP 4. In the "Datails" window, click the [Cancel] button' , function(){
        ...
        const cancel = 'Cancel'
        const attr_cancel = Details.cancel.getAttribute('content-desc')
