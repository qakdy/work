...
describe('coin transaction in 1 ru; Check the creation of an in-buy transaction with a changed coin value and a wallet selection from the drop-down list', function(){
