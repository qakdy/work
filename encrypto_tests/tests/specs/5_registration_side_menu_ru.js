...
describe('registration side menu 5 ru; Check registration in the application with empty fields', function(){
    ...
    it('EXPECTED RESULT. An informational message in red "Пожалуйста, введите имя" is displayed below the "My portfolio" field. Under the field "master password" an informational message is displayed in red "Пожалуйста, введите пароль". Under the "confirm password" field, an informational message is displayed in red "Пожалуйста, введите подтверждение пароля"', function(){
