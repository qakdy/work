...
describe('backup/restore test 4 en; Check zip file delete function', function(){
    ...
    it(' STEP 3. Select "Delete" from the drop down menu', function(){ 

        Backup_Restore.delete.click()

    }); 

    it('EXPECTED RESULT. The user is on the Backup/Restore page. ', function(){ 
        ...
        expect(Backup_Restore.show_menu).not.toBeDisplayed()
