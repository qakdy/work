...
describe('registration test 7 ru;Проверить создание портфолио при выборе на онбординг скрин   радиокнопку "Мастер-пароль и отпечаток пальца/Face ID(рекомендуется)"  или   "Только мастер пароль (наиболее безопасный)"с измененным полем "Мое портфолио" и заполенными полями пароль валидными данными', function(){
    ...
    it('STEP 1. Изменить данные в поле "Мое портфолио"', function(){
