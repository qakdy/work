...
describe('privacy policy 1 ru; Check the opening of the "Политика конфиденциальности" screen', function(){
    ...
    it('EXPECTED RESULT. The "Политика конфиденциальности" window opensin the Header of the page is displayed: - screen title "Политика конфиденциальностиPrivacy Policy"; - button [<].', function(){  
