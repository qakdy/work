...
describe('backup/restore test 5 ru; Test the dropdown menu on the zip file tile', function(){
    ...
    it('EXPECTED RESULT. After clicking on the drop-down menu button on the tile of the zip file, a drop-down menu is displayed with a choice:- "Поделиться"- "Удалить" ', function(){ 

        const attr_share = Backup_Restore.share_ru.getAttribute('displayed')
        expect(attr_share).toBe('true')
        
        const attr_delete = Backup_Restore.delete_ru.getAttribute('displayed')
