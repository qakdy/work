...
describe('coin transaction out 1 ru; Check the creation of an out-sell transaction with a changed coin value and a wallet selection from the drop-down list', function(){
    ...
    it('STEP 3. Select "Продажа" from the second drop-down list', function(){ 
       ...
       const text_buy = 'Продажа'
       const attr_text_buy = AddTransaction.sell_ru.getAttribute('content-desc')
       expect(text_buy).toBe(attr_text_buy)

       AddTransaction.sell_ru.click()
    })
