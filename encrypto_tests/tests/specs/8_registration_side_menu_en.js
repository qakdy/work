...
describe('registration side menu 8 en; Check the operation of the [<] button in the Header', function(){
    ...
    it('STEP 3. Press the [<] button in the header', function(){ 
       ...
       Create_Portfolio.back_btn.click()

    })  



    it('EXPECTED RESULT. After pressing the [Back] button in the Header, you go to the "Portfolio" page through which a new profile was created', function(){
