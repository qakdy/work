...
describe('registration side menu 7 en; Check portfolio creation without clicking the [Create] button', function(){
    ...
    it('STEP 5. In the "Confirm password" field, enter a password different from the one entered in the "Main password" field', function(){ 
    ...
    it('EXPECTED RESULT. There are no information messages for incorrectly entered data. The user does not go to the main screen of the app', function(){
