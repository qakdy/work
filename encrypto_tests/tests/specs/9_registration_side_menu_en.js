...
describe('registration side menu 9 en; Check registration in the application with the "My portfolio" field filled in by default and the fields "Master password", "Confirm password" validly filled in', function(){
    ...
    it('EXPECTED RESULT. The user is registered in the application. The main screen of the application opens with the name specified in the title when creating the "Portfolio". The created "Portfolio" is displayed in the side menu.', function(){ 
        ...
        const myportfolio_username_1 = 'My portfolio'
        const attr_myportfolio_username_1 = Burger_Menu.portofolio_default_en.getAttribute('content-desc')
