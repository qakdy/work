...
describe('registration test 9 ru; Проверить создание портфолио при выборе на онбординг скрин   радиокнопку "Мастер-пароль и отпечаток пальца/Face ID(рекомендуется)"  или   "Только мастер пароль (наиболее безопасный)"с пустым полями  "Мое портфолио" и "Основной пароль"', function(){
    ...
    it('EXPECTED RESULT. После нажатия кнопки [Создать] Под полем "Мое портфолио"отображается информационное сообщение красным цветом" Пожалуйста, введите имя". Под полем "Основной пароль" отображается информационное сообщение красным цветом" Пожалуйста, введите пароль". Под полем "Подтвердить пароль" отображается информационное сообщение красным цветом" Пароль не подходит".  ', function(){
