...
describe('registration test 2 ru; Проверить создание портфолио при выборе на онбординг скрин радиокнопку "Только мастер пароль (наиболее безопасный)"с пустыми полями паролей " ', function(){
    ...
    it('STEP 1-2. Поле "Мое портфолио" оставить заполненным по умолчанию; Поля "Основной пароль", "Подтвердить пароль" оставить пустыми', function(){
    ...
    it('EXPECTED RESULT. Под полем "Основной пароль"отображается информационное сообщение красным цветом" Пожалуйста,  введите пароль". Под полем "Подтвердите  пароль"  отображается информационное сообщение  красным цветом "Пожалуйста,  подтвердите пароль"', function(){
