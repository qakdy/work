...
describe('registration side menu 9 ru; Check registration in the application with the "Мое портфолио" field filled in by default and the fields "Основной пароль", "Потвердить пароль" validly filled in', function(){
    ...
    it('STEP 3. Leave the "Мое портфолио" field filled in by default', function(){ 
    ...
    it('STEP 5. Confirm field "Подтвердить пароль"', function(){ 
    ...
    it('EXPECTED RESULT. The user is registered in the application. The main screen of the application opens with the name specified in the title when creating the "Portfolio". The created "Portfolio" is displayed in the side menu.', function(){ 
        ...
        const myportfolio_username_1 = 'Мое портфолио'
        const attr_myportfolio_username_1 = Burger_Menu.portofolio_default_ru.getAttribute('content-desc')
