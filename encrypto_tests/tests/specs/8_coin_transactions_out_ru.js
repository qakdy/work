...
describe('coin transaction out 8 ru; Check the creation of an out-exchange transaction when pressing the [Отмена] button when entering the number of coins and filled in "USD" by default when choosing a wallet from the drop-down list.', function(){
