...
describe('registration test 14 en; Check portfolio creation when selecting the "Fingerprint/FaceID only (compromise)" radio button on the "Security" screen on the onboarding screen? or "Nothing, I have nothing to worry about" on the "Security" screen with "My Portfolio" filled in by default', function(){
