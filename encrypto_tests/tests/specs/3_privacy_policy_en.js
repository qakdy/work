...
describe('privacy policy 3 en; Check the work of the back button in the Header', function(){
    ...
    it('STEP 3. Press the [<] button in the header ', function(){  
        ...
        Privacy_Policy.back_btn.click()

        
    });  

    it('EXPECTED RESULT. After pressing the [Back] button in the Header, you go to the "Portfolio" page with name "Dmitriy Kasinskiy"', function(){  
