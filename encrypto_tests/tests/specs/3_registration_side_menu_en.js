...
describe('registration side menu 3 en; Check registration in the application with empty fields "My portfolio", "Confirm password"', function(){
    ...
    it('EXPECTED RESULT.Under the "My portfolio" field, an informational message is displayed in red "Please enter a name". Under the "Confirm password" field, an informational message is displayed in red "Please enter password confirmation"', function(){ 
