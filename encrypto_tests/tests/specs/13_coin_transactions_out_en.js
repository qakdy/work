...
describe('coin transaction out 13 en; Check the creation of a transaction when choosing out - exchange with an empty field "quantity" when filling in the field "USD" manually and selecting a wallet from the drop-down list and pressing the [Save] button', function(){
