...
describe('backup/restore test 1 en; Check the operation of the "Backup/Restore" function without pressing the [Backup] button', function(){
    ...
    it('PRECONDITION. The user is on the Backup/Restore screen from the drop down menu. STEP 1. Do not click on the [Backup] button', function(){ 
    ...
    it('EXPECTED RESULT. The user is on the Backup/Restore page. The header displays: - screen header, - button [<]. If the user has not previously saved Backup, only the [Backup] button is displayed on the main part of the screen', function(){ 
