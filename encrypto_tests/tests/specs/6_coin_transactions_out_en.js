...
describe('coin transaction out 6 en; Check the creation of an out-sell transaction by pressing the [Cancel] button when entering the number of coins and selecting a wallet from the drop-down list.', function(){
