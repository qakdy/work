...
describe('coin transaction out 7 ru; Check the creation of an out-transfer transaction by pressing the [Отмена] button when entering the number of coins and selecting a wallet from the drop-down list.', function(){
    ...
    it('STEP 9. Press the [Отмена] button', function(){ 
