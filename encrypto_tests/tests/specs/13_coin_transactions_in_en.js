...
describe('coin transaction in 13 en; Check the creation of an In-Exchange transaction with an empty "Amount" field, choosing a wallet from the drop-down list and manually entering the "USD" rate', function(){
