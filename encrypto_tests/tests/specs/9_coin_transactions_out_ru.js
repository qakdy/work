...
describe('coin transaction out 9 ru; Check the creation of a transaction by selecting out from the first drop-down menu, and in the second, leave the default value and pressing the [Отмена]', function(){
