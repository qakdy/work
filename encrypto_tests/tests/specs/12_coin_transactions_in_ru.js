...
describe('coin transaction in 12 ru; Check the creation of an In-Transfer transaction with an empty "Amount" field, a wallet selection from the drop-down list and a manually entered USD rate', function(){
