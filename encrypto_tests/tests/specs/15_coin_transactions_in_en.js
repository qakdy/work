...
describe('coin transaction in 15 en; Check the creation of an In-Staking transaction with an empty "Amount" field, choosing a wallet from the drop-down list and manually entering the "USD" rate', function(){
