...
describe('registration test 3 ru; Проверить создание портфолио при выборе на онбординг скрин радиокнопку "Только мастер пароль (наиболее безопасный)"с пустыми полем "Подтвердить пароль" ', function(){
    ...
    it('STEP 2. Заполнить поле "Основной пароль" .Поле, "Подтвердить пароль" оставить пустыми', function(){
    ...
    it('EXPECTED RESULT. Под полем "Подтвердите  пароль"  отображается информационное сообщение  красным цветом "Пожалуйста,  подтвердите пароль"', function(){
