...
describe('registration test 10 en; Check the creation of a portfolio when choosing on the onboarding screen the radio button "Master password and fingerprint / Face ID (recommended)" or "Only master password (most secure)" with empty fields "My portfolio" and "Confirm password"', function(){
    ...
    it('STEP 2. Fill in the field "Master password" ', function(){
    ...
    it('STEP 3. Leave the "Confirm Password" field blank', function(){
    ...
    it('EXPECTED RESULT. After clicking the [Create] button Under the "My portfolio" field, an informational message is displayed in red "Please enter a name." Under the "Confirm password" field, an informational message is displayed in red "Please enter password confirmation".', function(){
