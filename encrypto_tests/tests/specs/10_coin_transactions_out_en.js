...
describe('coin transaction out 10 en; Check the creation of a transaction when selecting out from the first drop-down menu, leave the default value in the second. Enter the number of coins manually and "USD" and pressing the [Cancel] button', function(){
