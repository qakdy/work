...
describe('coin transaction out 3 ru; Check the creation of an out-exchange transaction when pressing the [Save] button when deleting the value of the coin and selecting a wallet from the drop-down list', function(){
    ...
    it('STEP 5. Delete the entered coin value in the "USD" field', function(){ 
    ...
    it('EXPECTED RESULT. Below the "USD" input box, a message is displayed with the red text "Пожалуйста, введите количество"', function(){ 
