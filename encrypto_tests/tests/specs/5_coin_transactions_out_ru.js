...
describe('coin transaction out 5 ru; Check the creation of a transaction when choosing out from the first drop-down menu, and in the second drop-down menu, do not select a value when pressing the [Save] button, without changing "USD" and choosing a wallet from the drop-down list', function(){
    ...
    it('STEP 3. Enter in the field "Количество" entered the number of coins', function(){ 
    ...
    it('STEP 7. Press the [Сохранить] button', function(){ 
