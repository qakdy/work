...
describe('onboarding screen test 10 en; Проверить переключение радиокнопки  с  "Master password and Fingerprint/FaceID (recommended)"  на  "Fingerprint/FaceID (trade-off option)" ', function(){
    ...
    it('EXPECTED RESULT.Пользователь остается на  экране "Security Intro" где отображено: В header: - название экрана "Security Intro" Текст: - "As an additional security measure, you can encrypt the data with your own master password to make sure that your data is secured, even if your device is lost or stolen.". - "Select security measure: "Радиокнопки: - "Master password and Fingerprint/FaceID (recommended)" ; - "Master password only (the most secure)" с установленным чек боксом; - "Fingerprint/FaceID (trade-off option)"- "I have nothing to worry about" на экране "Security Intro" Кнопка: - [Next] ', function(){
