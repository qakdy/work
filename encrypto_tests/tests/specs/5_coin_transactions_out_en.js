...
describe('coin transaction out 5 en; Check the creation of a transaction when choosing out from the first drop-down menu, and in the second drop-down menu, do not select a value when pressing the [Save] button, without changing "USD" and choosing a wallet from the drop-down list', function(){
