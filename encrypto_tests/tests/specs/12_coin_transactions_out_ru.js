...
describe('coin transaction out 12 ru; Check the creation of a transaction when choosing out - transfer with an empty "quantity" field when filling in the "USD" field manually and selecting a wallet from the drop-down list by pressing the [Сохранить] button', function(){
