...
describe('registration test 4 en; Check the creation of a portfolio when choosing on the onboarding screen the radio button "Master password and fingerprint / Face ID (recommended)" or "Only master password (most secure)" with different passwords in the fields "Master password" "Confirm password"', function(){
