...
describe('sorting 2 en; Test the "Market cap" sorting', function(){
    ...
    it('Select "Market Up" from the drop-down menu', function(){  
        ...
        const attr_market_cap = Myportfolio.market_cap_en.getAttribute('content-desc')
        expect(market_cap).toBe(attr_market_cap)

        Myportfolio.market_cap_en.click()
