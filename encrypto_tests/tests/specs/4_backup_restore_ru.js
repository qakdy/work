...
describe('backup/restore test 4 ru; Check zip file delete function', function(){
    ...
    it(' STEP 3. Select "Удалить" from the drop down menu', function(){ 

        Backup_Restore.delete_ru.click()

    }); 

    it('EXPECTED RESULT. The user is on the Резервное копирование/Восстановление. ', function(){ 
        ...
        expect(Backup_Restore.show_menu_ru).not.toBeDisplayed()
