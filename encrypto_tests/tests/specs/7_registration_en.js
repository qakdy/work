...
describe('registration test 7 en; Check the creation of a portfolio when selecting on the onboarding screen the radio button "Master password and fingerprint / Face ID (recommended)" or "Only master password (most secure)" with the modified "My portfolio" field and the password fields filled in with valid data', function(){
    ...
    it('STEP 1. Change the data in the field "My portfolio"', function(){
