...
describe('coin transaction in 14 ru; Check the creation of an In-Mining transaction with an empty "Amount" field, choosing a wallet from the drop-down list and manually entering the "USD" rate', function(){
