...
describe('coin transaction out 4 en; Check the creation of a transaction when choosing out from the first drop-down menu, and in the second one leave the default value when pressing the [Save] button, without changing "USD" and entering the name of the wallet manually', function(){
    ...
    it('STEP 2. From the first drop-down menu select "Out"; in the second leave the default value', function(){  
       ...
       driver.touchAction({
        ...
        const attr_text_sell = AddTransaction.sell.getAttribute('content-desc')
        expect(text_sell).toBe(attr_text_sell)
     
        AddTransaction.sell.click()
    })

    it('STEP 3. Enter in the field "Amount" entered the number of coins', function(){ 
