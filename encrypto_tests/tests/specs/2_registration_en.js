...
describe('registration test 2 en; Проверить создание портфолио при выборе на онбординг скрин радиокнопку "Master password only (the most secure)" с пустыми полями паролей " ', function(){
    ...
    it('EXPECTED RESULT. Under the field "master password" an informational message is displayed in red "Please Enter password". Under the "confirm password" field, an informational message is displayed in red "Please re enter password"', function(){
