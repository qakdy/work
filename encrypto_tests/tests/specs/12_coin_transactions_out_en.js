...
describe('coin transaction out 12 en; Check the creation of a transaction when choosing out - transfer with an empty "quantity" field when filling in the "USD" field manually and selecting a wallet from the drop-down list by pressing the [Save] button', function(){
    ...
    it('EXPECTED RESULT. Under the fileds "Quantity" an informational message is displayed in red "Please Enter quantity"', function(){ 


        const usd_red_message = 'Please Enter quantity'
        const attr_usd_red_message = AddTransaction.red_message.getAttribute('content-desc')
