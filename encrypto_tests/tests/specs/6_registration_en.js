...
describe('registration test 6 en; Check the creation of a portfolio when choosing on the onboarding screen the radio button "Master password and fingerprint / Face ID (recommended)" or "Master password only (most secure)" only with the "Confirm password" field filled in', function(){
    ...
    it('STEP 3. Fill in the "Confirm password" field with the same data as the "Main password" field', function(){
    ...
    it('EXPECTED RESULT. After clicking the [Create] button, the user successfully creates a portfolio and goes to the main application window with the profile name "My Portfolio"', function(){
        ...
        const text_header = 'My portfolio'
        const attr_text_header = Myportfolio.default_header_en.getAttribute('content-desc')
