...
describe('registration side menu 2 en; Check registration in the application with an empty field "My portfolio" and validly filled fields "Master password", "Confirm password"', function(){
    ...
    it('EXPECTED RESULT.Under the "My portfolio" field, an informational message is displayed in red "Please enter a name".', function(){ 
