...
describe('coin transaction in 4 en; Check the creation of an In-Mining transaction with the current value of the coin and the choice of wallet from the drop-down list', function(){
