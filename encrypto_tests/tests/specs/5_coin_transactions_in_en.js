...
describe('coin transaction in 5 en; Check the creation of an In-Staking transaction with the current value of the coin and the addition of a new wallet name', function(){
    ...
    it('STEP 3. Select "Staking" from the second drop-down list', function(){ 
       ...
       const text_staking = 'Staking'
       const attr_text_staking = AddTransaction.staking.getAttribute('content-desc')
       expect(text_staking).toBe(attr_text_staking)

       AddTransaction.staking.click()
    })
    ...
    it('STEP 5. Enter a new wallet name', function(){ 

        AddTransaction.wallet_exchange.click()
        AddTransaction.wallet_exchange.setValue('Metamask')
        driver.pressKeyCode(66)
