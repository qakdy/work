...
describe('registration side menu 3 ru; Check registration in the application with empty fields "Мое портфолио", "Потвердить пароль"', function(){
    ...
    it('EXPECTED RESULT.Under the "Мое портфолио" field, an informational message is displayed in red "Пожалуйста, введите имя". Under the "Confirm password" field, an informational message is displayed in red "Пожалуйста, введите подтверждение пароля"', function(){ 
