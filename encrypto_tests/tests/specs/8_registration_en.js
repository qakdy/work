...
describe('registration test 8 en; Check the creation of a portfolio when choosing on the onboarding screen, the radio button "Master password and fingerprint / Face ID (recommended)" or "Only master password (most secure)" with an empty field "My portfolio" and filled fields password valid data', function(){
