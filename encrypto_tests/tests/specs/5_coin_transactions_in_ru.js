...
describe('coin transaction in 5 ru; Check the creation of an In-Staking transaction with the current value of the coin and the addition of a new wallet name', function(){
    ...
    it('STEP 3. Select "Стейкинг" from the second drop-down list', function(){ 
       ...
       const text_staking = 'Стейкинг'
       const attr_text_staking = AddTransaction.staking_ru.getAttribute('content-desc')
       expect(text_staking).toBe(attr_text_staking)

       AddTransaction.staking_ru.click()
    })
