...
describe('onboarding screen test 15 en ; Проверить переключение радиокнопки  с  "Master password and Fingerprint/FaceID (recommended)"  на  "Fingerprint/FaceID (trade-off option)"  ', function(){
