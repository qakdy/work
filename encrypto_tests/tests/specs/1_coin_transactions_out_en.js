...
describe('coin transaction out 1 en; Check the creation of an out-sell transaction with a changed coin value and a wallet selection from the drop-down list', function(){
    ...
    it('STEP 3. Select "Sell" from the second drop-down list', function(){ 
       ...
       const text_buy = 'Sell'
       const attr_text_buy = AddTransaction.sell.getAttribute('content-desc')
