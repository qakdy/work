...
describe('add coin test 2 ru; View added coins in "Profile" when scrolling through the profile without nearby dots on the "Детали" screen', function(){
    ...
    it('EXPECTED RESULT. The user remains in the "Детали" window and is not redirected to the "Profile" page' , function(){
