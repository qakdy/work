...
describe('coin transaction out 4 ru; Check the creation of a transaction when choosing out from the first drop-down menu, and in the second one leave the default value when pressing the [Save] button, without changing "USD" and entering the name of the wallet manually', function(){
