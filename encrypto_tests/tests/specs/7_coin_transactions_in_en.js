...
describe('coin transaction in 7 en; Check the creation of an In-Transfer transaction with the current value of the coin and the choice of wallet from the drop-down menu when canceling the transaction', function(){
    ...
    it('STEP 9. Press the [Cancel] button', function(){ 
