...
describe('privacy policy 2 en; Check scrolling page "Privacy Policy"', function(){
    ...
    it('EXPECTED RESULT. The "Privacy Policy" window opensin the Header of the page is displayed: - screen title "Privacy Policy"; - button [<]. The main part of the screen displays: - information about "Privacy Policy"', function(){  
