...
describe('registration side menu 6 ru; Register in the application with mismatched data in the fields "Основнйо пароль, "Потвердить пароль"', function(){
    ...
    it('STEP 3. Leave the "My portfolio" field filled in by default', function(){ 
    ...
    it('STEP 5. In the "Подтвердить пароль" field, enter a password different from the one entered in the "Основной пароль" field', function(){ 

        const text_confirm_password = 'Подтвердить пароль'
        const attr_confirm_password = Create_Portfolio.password_2.getAttribute('text')
        expect(attr_confirm_password).toBe(text_confirm_password)
        Create_Portfolio.password_2.click()
        Create_Portfolio.password_2.setValue(4321)
    ...
    it('EXPECTED RESULT. Under the "Потвердить пароль" field, an informational message is displayed in red "Пароль не подходит"', function(){
