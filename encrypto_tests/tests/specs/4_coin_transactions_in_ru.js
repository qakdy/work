...
describe('coin transaction in 4 ru; Check the creation of an In-Mining transaction with the current value of the coin and the choice of wallet from the drop-down list', function(){
    ...
    it('STEP 3. Select "Майнинг" from the second drop-down list', function(){ 
       ...
       const text_mining = 'Майнинг'
       const attr_text_mining = AddTransaction.mining_ru.getAttribute('content-desc')
       expect(text_mining).toBe(attr_text_mining)

       AddTransaction.mining_ru.click()
    })
