...
describe('registration test 9 en; Check the creation of a portfolio when choosing on the onboarding screen the radio button "Master password and fingerprint / Face ID (recommended)" or "Only master password (most secure)" with empty fields "My portfolio" and "Main password"', function(){
    ...
    it('EXPECTED RESULT. After clicking the [Create] button Under the "My portfolio" field, an informational message is displayed in red "Please enter a name." Under the "Main password" field, an information message in red "Please enter a password" is displayed. Under the "Confirm password" field, an informational message is displayed in red "Password does not match".', function(){
