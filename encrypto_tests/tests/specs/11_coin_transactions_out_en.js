...
describe('coin transaction out 11 en; Check the creation of a transaction when choosing out - sell with an empty field "quality" and "USD" and choosing a wallet from the drop-down list by pressing the [Save] button', function(){
    ...
    it('EXPECTED RESULT. Under the fileds  "USD" and "Quality" an informational message is displayed in red "Please Enter quantity"', function(){ 
