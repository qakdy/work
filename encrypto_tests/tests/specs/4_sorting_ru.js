...
describe('sorting 4 ru; Test the "Падение" sorting', function(){
    ...
    it('Select "Падение" from the drop-down menu', function(){  
        ...
        const trend_down = "Падение"
        const attr_trend_down = Myportfolio.trend_down_ru.getAttribute('content-desc')
        expect(trend_down).toBe(attr_trend_down)

        Myportfolio.trend_down_ru.click()
