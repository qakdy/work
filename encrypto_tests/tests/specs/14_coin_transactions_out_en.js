...
describe('coin transaction out 14 en; Check the creation of a transaction when choosing out from the first drop-down menu, leave the default value in the second one, with an empty "quantity" field with the "USD" field filled in by default and choosing a wallet from the drop-down list and pressing the [Save] button', function(){
