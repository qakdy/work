...
describe('registration side menu 4 en; Check registration in the application with empty fields "My portfolio", "Main password"', function(){
    ...
    it('STEP 3. Delete data "My Portfolio" field', function(){ 
    ...
    it('STEP 5. Click button "Create"', function(){ 
    ...
    it('EXPECTED RESULT.Under the "My portfolio" field, an informational message is displayed in red "Please enter a name". Under the "Confirm password" field, an informational message is displayed in red "Password does not match" Under the "Master Password" field, an informational message is displayed in red "Please enter password."', function(){ 
