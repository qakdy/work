...
describe('backup/restore test 1 ru; Check the operation of the "Резервное копирование/Восстановление" function without pressing the [Backup] button', function(){
    ...
    it('PRECONDITION. The user is on the Резервное копирование/Восстановление screen from the drop down menu. STEP 1. Do not click on the [Резервное копирование/Восстановление] button', function(){ 
    ...
    it('EXPECTED RESULT. The user is on the Резервное копирование/Восстановление page. The header displays: - screen header, - button [<]. If the user has not previously saved Backup, only the [Резервное копирование/Восстановление] button is displayed on the main part of the screen', function(){ 
        ...
        const attr_back_btn = Backup_Restore.backup_btn_ru.getAttribute('displayed')
