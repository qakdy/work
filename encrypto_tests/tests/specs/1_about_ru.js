...
describe('about test 1 ru; Check the opening of the "О приложении" screen', function(){
    ...
    it('EXPECTED RESULT. The "About" window opens in the Header of the page is displayed: - screen title "О приложении"; - button [<]. The main part of the screen displays: - application logo; -app name; - text "Платформа"; - platform icon; - platform name; - active link encryptoportfolio.com', function(){  
        ...
        const platform_text = 'Платформа'
        const attr_platform = About.platform_ru.getAttribute('content-desc')
