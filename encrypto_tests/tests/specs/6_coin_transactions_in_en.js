...
describe('coin transaction in 6 en; Check the creation of an In-Buy transaction with the current value of the coin and the choice of wallet from the drop-down menu when canceling the transaction', function(){
