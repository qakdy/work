...
describe('coin transaction in 11 en; Check the creation of an In-Buy transaction with empty fields "Quantity", "Token"', function(){
    ...
    it('STEP 3. Select "Buy" from the second drop-down list', function(){ 
        ...
        const text_buy = 'Buy'
        const attr_text_buy = AddTransaction.buy.getAttribute('content-desc')
        expect(text_buy).toBe(attr_text_buy)
 
        AddTransaction.buy.click()
    })


    it('STEP 4. Delete data in the "USD" field', function(){ 

    
        AddTransaction.usd_form_btc.click()
        AddTransaction.usd_form_btc.setValue('')
        driver.pressKeyCode(66)

        const text_usd_from_btc = 'Price'
    ...
    it('STEP 8. Press the [Save] button', function(){ 

        AddTransaction.save.click()

    })  

    it('EXPECTED RESULT. The transaction has not been added and is not displayed in the list of all transactions on the page. Also, the information in the static top of the page has remained unchanged. Below the "quantity" field, an informational message is displayed with the red text "Please enter the quantity" . Below the "USD/Tokena" field, an informational message is displayed with the red text "Please enter the quantity"', function(){ 
        ...
        const usd_red_message_2 = 'Please Enter quantity'
        const attr_usd_red_message_2 = AddTransaction.red_message_2.getAttribute('content-desc')
