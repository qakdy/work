...
describe('registration test 14 ru; Check portfolio creation when selecting the "Только отпечаток пальца/FaceID(компромиссный вариант)" radio button on the "Security" screen on the onboarding screen? or "Ничего, мне не о чем беспокоиться" on the "Безопасность" screen with "Мое портфолио" filled in by default', function(){
    ...
    it('STEP 1. Leave the "Мое портфолио" field filled in by default ', function(){
