...
describe('onboarding screen test 10 ru; Проверить переключение радиокнопки  с  "Мастер-пароль и отпечаток пальца/Face ID(рекомендуется)"  на  "Только мастер пароль (наиболее безопасный)" ', function(){
