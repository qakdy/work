...
describe('registration side menu 7 ru; Check portfolio creation without clicking the [Создать] button', function(){
    ...
    it('EXPECTED RESULT. There are no information messages for incorrectly entered data. The user does not go to the main screen of the app', function(){
        ...
        expect(Myportfolio.default_header_ru).not.toBeDisplayed()
