...
describe('coin transaction in 3 ru; Check the creation of an In-Exchange transaction with an empty field coin value', function(){
    ...
    it('STEP 5. Delete data in the "USD" field', function(){ 
    ...
    it('EXPECTED RESULT. Below the "USD Token" input window, a message is displayed with the red text "Пожалуйста, введите количество"', function(){ 
