...
describe('registration test 1 en; Check the creation of a portfolio when choosing on the onboarding screen the radio button "Master password and fingerprint / Face ID (recommended)" and "Only master password (most secure)" with empty fields ', function(){

    it('PRECONDITION. The user went through the onboarding screen and selected the Master password only (the most secure) radio button on the security screen', function(){        
    ...
    it('STEP 1-2. In the "My portfolio" field, delete the text; Leave "master password", "confirm password" fields blank', function(){
    ...
    it('EXPECTED RESULT. An informational message in red "Please Enter name" is displayed below the "My portfolio" field. Under the field "master password" an informational message is displayed in red "Please Enter password". Under the "confirm password" field, an informational message is displayed in red "Please re enter password"', function(){
