...
describe('sorting 1 en; Test the "Holdings" sorting', function(){
    ...
    it('Select "Holdings" from the drop-down menu', function(){  
        ...
        const attr_holdings = Myportfolio.holdings_en.getAttribute('content-desc')
        expect(holdings).toBe(attr_holdings)

        // const text_holdings = "Wallet Balance $ 0.0 Show menu Holdings"
        // const attr_holdings_text = Myportfolio.balance_en.getAttribute('content-desc')
        // expect(text_holdings).toBe(attr_holdings_text)
