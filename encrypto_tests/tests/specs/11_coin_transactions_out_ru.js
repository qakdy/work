...
describe('coin transaction out 11 ru; Check the creation of a transaction when choosing out - sell with an empty field "quality" and "USD" and choosing a wallet from the drop-down list by pressing the [Сохранить] button', function(){
    ...
    it('STEP 4. Delete data from the "USD" field', function(){ 

    
        AddTransaction.usd_form_btc.click()
        AddTransaction.usd_form_btc.clearValue()
        driver.pressKeyCode(66)

        const text_usd_from_btc = 'Цена'
    ...
    it('EXPECTED RESULT. Under the fileds  "USD" and "Quality" an informational message is displayed in red "Пожалуйста, введите количество"', function(){ 
        ...
        const usd_red_message_2 = 'Пожалуйста, введите количество'
        const attr_usd_red_message_2 = AddTransaction.red_message_2_ru.getAttribute('content-desc')
        expect(usd_red_message_2).toBe(attr_usd_red_message_2)
