...
describe('sorting 4 en; Test the "Trend Down" sorting', function(){
    ...
    it('Select "Trend Down" from the drop-down menu', function(){  
        ...
        const attr_trend_down = Myportfolio.trend_down_en.getAttribute('content-desc')
        expect(trend_down).toBe(attr_trend_down)

        Myportfolio.trend_down_en.click()
