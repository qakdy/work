...
describe('sorting 3 en; Test the "Trend Up" sorting', function(){
    ...
    it('Select "Trend Up" from the drop-down menu', function(){  
        ...
        const attr_trend_up = Myportfolio.trend_up_en.getAttribute('content-desc')
        expect(trend_up).toBe(attr_trend_up)

        Myportfolio.trend_up_en.click()
